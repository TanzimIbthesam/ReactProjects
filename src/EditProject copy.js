...
const EditProject=()=>{
    ...
    const { data:allproject}=useFetch('http://localhost:8000/allprojects/'+id);
    ...
    const handleClick=(e)=>{
        e.preventDefault();
         const allproject={title,description,isCompleted};
         
       
          
         axios.put(`http://localhost:8000/allprojects/${id}`,allproject)
